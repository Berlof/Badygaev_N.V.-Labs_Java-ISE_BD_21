...
public class FormTractor {
	...
	private void initialize() {
		...
		buttonCreate = new JButton("Бульдозер");
		...
		buttonRight.setIcon(new ImageIcon("E:\\\\Java-lab1\\\\lab_Java\\\\Resources\\Right.png"));
		...
		buttonDown.setIcon(new ImageIcon("E:\\\\Java-lab1\\\\lab_Java\\\\Resources\\Down.png"));
		...
		JButton button = new JButton("Трактор");
